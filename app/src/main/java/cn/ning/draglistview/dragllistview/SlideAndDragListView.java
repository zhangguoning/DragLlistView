...
public class SlideAndDragListView<T> extends DragListView<T> implements WrapperAdapter.OnAdapterSlideListenerProxy,
        ...
        WrapperAdapter.OnScrollListenerProxy /*, AbsListView.OnItemLongClickListener */,DragListViewListener{
    /* onTouch里面的状态 */
...
//    }
    ...
    public void startDragItem(int position){
...
//                mOnListItemLongClickListener.onListItemLongClick(itemMainLayout.getItemCustomView(), position);
    ...
    public void updateDataListView (ListAdapter adapter , List<T> dataList){
        setAdapter(adapter);
...
//            List<View> viewList = ViewUtil.getAllChildView(view);
//            for(View v : viewList){
//                if(v.getId() == R.id.conent_rl){
...
//            }
            ...
            setDragPosition(view ,position, false);
    ...
    /**
     * {@link #(OnListItemLongClickListener)}
     *
     * @param listener
     */
    @Deprecated
